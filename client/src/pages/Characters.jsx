        ...
        {(activeTab === 'Hiragana' || activeTab === 'Katakana') && (
          <div className="mb-8 flex justify-center sm:justify-start">
            <Link
              ...
              className="w-full sm:w-fit px-8 py-2 flex items-center justify-center font-bold text-lg text-white dark:text-slate-800 bg-blue-500 hover:bg-blue-600 dark:bg-sky-400 dark:hover:bg-sky-500 rounded-xl"
            >
